 ...
 *    (C) 1999, Peches et Oceans Canada
 *  
 ...
 *
 * @source $URL$
 * @version $Id: SeaWater.java,v 1.1 2007/02/15 20:14:34 luisbermudez Exp $
...
public final class SeaWater {
    /*
     * Note: Les algorithmes originaux de l'UNESCO recevait en entres
     *       des pressions en decibars. Les algorithmes ecrites par
     *       Bernard Pelchat recevaient en entres des pressions en
     *       MegaPascal. La premiere ligne de code des algorithmes
    ...
    /**
     * Coefficients de l'equation d'etat EOS-80. La densite
     * calculee par ces coefficients est la densite Sigma-T.
     */
    ...
    /**
     * Coefficients de l'equation d'etat EOS-80. La densite
     * calculee par ces coefficients est la densite "vrai".
     */
    private static final double
    ...
    /**
     * Coefficients de l'equation de la salinite PSS-78.
     */
    private static final double
    ...
    /**
     * Coefficients pour les salinites elevees,
     */
    private static final double
    ...
    /**
     * Constantes necessaires au calcul de la chaleur specifique.
     *
     * @see #specificHeat
     */
    private static final double
    ...
    /**
     * Constantes necessaires au calcul de la temperature adiabetique.
     *
    ...
    /**
     * Constantes necessaires au calcul de la profondeur.
     *
     * @see #depth
     */
    private static final double
    ...
    /**
     * Constantes necessaires au calcul de la vitesse du son.
     *
     * @see #soundVelocity
     */
    private static final double
    ...
    /**
     * Constantes necessaires au calcul de la saturation en oxygene dissous.
     *
     * @see #saturationO2
     */
    private static final double
    ...
    public static double salinity(double C, final double T, final double P) {
        ...
        if (!(C < 5E-4)) { // use '!' in order to accept NaN
            ...
            /*
             * Calcule la salinite pour une eau de conductivite,
             * de temperature et de pression donnees. Cet algorithme
             * doit etre utilise lorsque l'on s'attend a une salinite
             * entre 42 et 50.
             */
     ...
     * @param S Salinity PSS-78.
     * @param T Temperature (*C).
     * @return  Saturation in disolved oxygen (umol/kg).
     */
    ...
    /**
     * Calcule la valeur d'un polynome.
     ...
     * </pre></blockquote>
     *
     * ou C est un vecteur de coefficients transmis en argument.
     * Une exception sera levee si ce tableau ne contient pas
     * au moins 1 element.
     *
     * @param x Valeur x a laquelle calculer le polynome.
     * @param c Coefficients C du polynome.
     * @return  La valeur du polynome au x specifie.
     *
