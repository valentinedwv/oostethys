package org.oostethys.test.issues;
...
//				"http://mmisw.org/ont/cf/parameter/pressure", null, null);
		...
		try{
		oni.process();
		fail("if latitude is missing it should throw an exception");
		}catch ( Exception e){
			assertTrue(e.getMessage().contains("latitude variable is missing"));
		}
