...
xmlns:app="http://www.deegree.org/app" xmlns:iso19119="http://schemas.opengis.net/iso19119" xmlns:smXML="http://metadata.dgiwg.org/smXML" 
xmlns:iso19115brief="http://schemas.opengis.net/iso19115brief">
			...
			<xsl:if test="app:hierarchyLevelCode">
				<hierarchyLevel>
					<smXML:MD_ScopeCode>
						...
						<xsl:attribute name="codeListValue"><xsl:value-of select="app:hierarchyLevelCode/app:HierarchyLevelCode/app:codelistvalue"/></xsl:attribute>
					</smXML:MD_ScopeCode>
				</hierarchyLevel>
			</xsl:if>
			...
			<xsl:if test="app:characterSet">
				<smXML:characterSet>
					<smXML:MD_CharacterSetCode>
						...
						<xsl:attribute name="codeListValue"><xsl:value-of select="app:characterSet/app:MD_CharacterSetCode/app:codelistvalue"/></xsl:attribute>
					</smXML:MD_CharacterSetCode>
				</smXML:characterSet>
			</xsl:if>
	...
	<xsl:template name="CSW_SERVICEIDENTIFICATION_BRIEF">
		<iso19115brief:CSW_ServiceIdentification>
			<title>			
				<smXML:CharacterString>
					<xsl:value-of select="app:CSW_ServiceIdentification/app:identificationInfo/app:MD_Identification/app:citation/app:CI_Citation/app:title"></xsl:value-of>
				</smXML:CharacterString>
			</title>
			<serviceType>
				<smXML:CharacterString><xsl:value-of select="app:CSW_ServiceIdentification/app:servicetype"/></smXML:CharacterString>
			</serviceType>
			<xsl:for-each select="app:CSW_ServiceIdentification/app:serviceTypeVersion">
				<serviceTypeVersion>
					<smXML:CharacterString><xsl:value-of select="."/></smXML:CharacterString>
				</serviceTypeVersion>
			</xsl:for-each>
			...
			<couplingType>
				<iso19119:CSW_CouplingType codeList="http://schemas.opengis.net/iso19119/couplingType">
					<xsl:attribute name="codeListValue"><xsl:value-of select="app:CSW_ServiceIdentification/app:couplingType/app:CSW_CouplingType/app:codelistvalue"/></xsl:attribute>
...
-->				
				<iso19119:couplingType>
					<iso19119:CSW_CouplingType codeList="http://schemas.opengis.net/iso19119/couplingType">
						<xsl:attribute name="codeListValue"><xsl:value-of select="app:couplingType/app:CSW_CouplingType/app:codelistvalue"/></xsl:attribute>
					</iso19119:CSW_CouplingType>
				</iso19119:couplingType>
			</iso19119:CSW_ServiceIdentification>
		</smXML:identificationInfo>
