...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ows="http://www.opengis.net/ows" xmlns:ogc="http://www.opengis.net/ogc" xmlns:sos="http://www.opengis.net/sos/1.0" xmlns:gml="http://www.opengis.net/gml" xmlns:java="java" xmlns:ows2iso="de.latlon.bkg.OWS2ISO19119" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:xlink="http://www.w3.org/1999/xlink" exclude-result-prefixes="java ows2iso sos ogc ows gml">
	...
	<xsl:template match="sos:Capabilities">
		<gmd:MD_Metadata xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.isotc211.org/2005/gmd ..\schema\iso\19139\20060504\gmd\metadataEntity.xsd http://www.isotc211.org/2005/srv ..\schema\iso\19139\20060504\srv\serviceMetadata.xsd">
			<gmd:fileIdentifier>
				<gco:CharacterString>
			...
			<gmd:contact>
				<xsl:choose>
					<xsl:when test="boolean( ows:ServiceProvider )">
						<xsl:call-template name="sos_service_respParty"/>
					</xsl:when>
					<xsl:otherwise>
	...
	<xsl:template name="sos_service_respParty">
		<!--
			template for adding a reesponsible party from service section of SOS capabilities
		-->
	...
	<xsl:template name="identification">
		<gmd:identificationInfo>
			<srv:SV_ServiceIdentification>
				...
				<xsl:apply-templates select="//sos:ObservationOfferingList/sos:ObservationOffering"/>
			</srv:SV_ServiceIdentification>
		</gmd:identificationInfo>
	</xsl:template>
	...
	<xsl:template match="sos:ObservationOffering">
		<srv:operatesOn>
			<gmd:MD_DataIdentification>
				<gmd:citation>
					<gmd:CI_Citation>
						...
						<gmd:date>
							<!--
									date is required but there is no way to to read its value from a SOS capabilities
				...
				<gmd:topicCategory>
					<!--
							topicCategory is required but there is no way to read its value from a SOS capabilities
							document nor to set a meaningful default
						-->
					<gmd:MD_TopicCategoryCode>sensor</gmd:MD_TopicCategoryCode>
				</gmd:topicCategory>
			</gmd:MD_DataIdentification>
		</srv:operatesOn>
	</xsl:template>
