...
<xsl:stylesheet version="1.0" 
	...
	<xsl:template name="dataident_brief">
		...
		<xsl:template name="citation_brief">
			<gmd:CI_Citation>
				...
				<xsl:if test="app:identificationInfo/app:MD_Identification/app:citation/app:CI_Citation/app:publicationdate">
					<gmd:date>
						<gmd:CI_Date>
							<gmd:date>
								<gco:DateTime>
									<xsl:call-template name="toISODateTime">
										<xsl:with-param name="datetime">
											<xsl:value-of select="app:identificationInfo/app:MD_Identification/app:citation/app:CI_Citation/app:publicationdate" />
										</xsl:with-param>
									</xsl:call-template>
								</gco:DateTime>
							</gmd:date>
	...
	<xsl:variable name="citationPath" select="app:identificationInfo/app:MD_Identification/app:citation/app:CI_Citation"/>
		<gmd:CI_Citation>
			...
			<xsl:if test="$citationPath/app:publicationdate">
				<gmd:date>
					<gmd:CI_Date>
						<gmd:date>
							<gco:DateTime>
								<xsl:call-template name="toISODateTime">
									<xsl:with-param name="datetime">
										<xsl:value-of select="$citationPath/app:publicationdate" />
									</xsl:with-param>
								</xsl:call-template>
							</gco:DateTime>
						</gmd:date>
	...
	<xsl:template name="dqelement1">
		<gmd:result>
			<gmd:DQ_QuantitativeResult>
				<gmd:valueUnit>
					<gml:UnitDefinition>
						<gml:identifier><xsl:value-of select="app:uomname1" /></gml:identifier>
						<gml:name><xsl:value-of select="app:uomname1" /></gml:name>
					</gml:UnitDefinition>
				</gmd:valueUnit>
<!--	UNKLAR!!! alte Version lässt sich nicht eins zu eins auf die neue übertragen. Was ist gewollt? DB-Schema anpassen!
				<smXML:UomLength>
					<smXML:uomName>
	...
	<xsl:template name="dqelement2">
		<gmd:result>
			<gmd:DQ_QuantitativeResult>
				<gmd:valueUnit>
					<gml:UnitDefinition>
						<gml:identifier><xsl:value-of select="app:uomname2" /></gml:identifier>
						<gml:name><xsl:value-of select="app:uomname2" /></gml:name>
					</gml:UnitDefinition>
				</gmd:valueUnit>
<!-- UNKLAR!!! s.o.
				<smXML:UomLength>
