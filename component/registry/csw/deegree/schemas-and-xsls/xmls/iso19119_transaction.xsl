...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:smXML="http://metadata.dgiwg.org/smXML" xmlns:app="http://www.deegree.org/app" xmlns:iso19119="http://schemas.opengis.net/iso19119">
			...
			<app:CSW_ServiceIdentification>
				<app:identificationInfo>
					<app:MD_Identification>
						...
						<xsl:for-each select="smXML:resourceConstraints">
				...
				<xsl:if test="boolean( iso19119:restrictions )">
					<app:restrictions>
				...
				<xsl:for-each select="iso19119:extent/smXML:EX_Extent/smXML:geographicElement/smXML:EX_GeographicBoundingBox">
				...
				<xsl:for-each select="iso19119:coupledResource">
					<app:coupledResource>
						<xsl:apply-templates select="."/>
					</app:coupledResource>
				</xsl:for-each>
	...
	<xsl:template match="iso19119:SV_Parameter">
		<app:SV_Parameter>
			...
			<app:type>
				<xsl:value-of select="iso19119:name/smXML:MemberName/smXML:attributeType/smXML:TypeName/smXML:aName/smXML:CharacterString"/>
			</app:type>
			<app:direction>
	...
	<xsl:template match="iso19119:operatesOn">
		...
		<xsl:if test="boolean( smXML:MD_DataIdentification  )">
			<app:OperatesOn>
				<app:name>
					<xsl:value-of select="smXML:MD_DataIdentification/smXML:citation/smXML:CI_Citation/smXML:identifier/smXML:MD_Identifier/smXML:code/smXML:CharacterString"/>
				</app:name>
				<app:title>
					<xsl:value-of select="smXML:MD_DataIdentification/smXML:citation/smXML:CI_Citation/smXML:title/smXML:CharacterString"/>
				</app:title>
				<app:abstract>
	...
	<xsl:template match="iso19119:coupledResource">
		<app:CoupledResource>
			<app:operationName>
				<app:OperationNames>
					<app:name>
						<xsl:value-of select="iso19119:CSW_CoupledResource/iso19119:operationName/smXML:CharacterString"/>
					</app:name>
				</app:OperationNames>
			</app:operationName>
			<xsl:for-each select="iso19119:CSW_CoupledResource/iso19119:identifier">
				<app:identifier>
					<xsl:value-of select="smXML:CharacterString"/>
				</app:identifier>
			</xsl:for-each>
