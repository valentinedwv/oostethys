...
<xsl:stylesheet version="1.0" xmlns:wfs="http://www.opengis.net/wfs" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:app="http://www.deegree.org/app" xmlns:iso19115="http://schemas.opengis.net/iso19115full" xmlns:iso19115summary="http://schemas.opengis.net/iso19115summary" xmlns:iso19115brief="http://schemas.opengis.net/iso19115brief" xmlns:iso19119="http://schemas.opengis.net/iso19119" xmlns:smXML="http://metadata.dgiwg.org/smXML" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:java="java" xmlns:minmax="org.deegree.framework.xml.MinMaxExtractor" >
	<!-- ================================================================== -->
	...
	<xsl:template name="dataident_summary">
		<iso19115summary:MD_DataIdentification>
			...
			<xsl:choose>
				<xsl:when test="boolean( app:identificationInfo/app:MD_Identification/app:resourceConstraints )">
				...
				<xsl:otherwise>
					<resourceConstraints>
						<smXML:MD_Constraints>
							<smXML:useLimitation>
								<smXML:CharacterString>Dies ist ein dummy-Wert, der aufgrund eines Fehlers in der ISO19115 summary Schemadefinition erforderlich ist.</smXML:CharacterString>
							</smXML:useLimitation>
						</smXML:MD_Constraints>
					</resourceConstraints>
				</xsl:otherwise>
			...
			<xsl:for-each select="app:spatialRepresentationType">
				<spatialRepresentationType>
					<smXML:MD_SpatialRepresentationTypeCode>
						...
						<xsl:attribute name="codeListValue"><xsl:value-of select="app:MD_SpatialRepTypeCode/app:codelistvalue"/></xsl:attribute>
					</smXML:MD_SpatialRepresentationTypeCode>
				</spatialRepresentationType>
			</xsl:for-each>
			...
			<xsl:for-each select="app:characterSet">
				<characterSet>
					<smXML:MD_CharacterSetCode>
						...
						<xsl:attribute name="codeListValue"><xsl:value-of select="app:MD_CharacterSetCode/app:codelistvalue"/></xsl:attribute>
					</smXML:MD_CharacterSetCode>
				</characterSet>
			</xsl:for-each>
			<xsl:for-each select="app:topicCategory">
								...
								<gml:TimeInstant>
									<gml:timePosition>
										<xsl:choose>
											...
											<xsl:otherwise>
												<xsl:value-of select="concat( app:EX_TemporalExtent/app:begin_, 'T00:00:00')"/>
											</xsl:otherwise>
										</xsl:choose>
									</gml:timePosition>
								</gml:TimeInstant>
								...
								<gml:TimeInstant>
									<gml:timePosition>
										<xsl:choose>
											...
											<xsl:otherwise>
												<xsl:value-of select="concat( app:EX_TemporalExtent/app:end_, 'T00:00:00')"/>
											</xsl:otherwise>
										</xsl:choose>
									</gml:timePosition>
								</gml:TimeInstant>
	...
	<xsl:template name="summary_distributioninfo">
		<distributionInfo>
			<iso19115summary:MD_Distribution>
				<xsl:for-each select="app:format/app:MD_Format">
					<distributionFormat>
				...
				<xsl:for-each select="app:distributionInfo.digitalTransferOptions">
		...
		<transferOptions>
			<iso19115summary:MD_DigitalTransferOptions>
				...
				<xsl:if test="app:MD_DigTransferOpt/app:onlineResource">
					<onLine>
						<xsl:apply-templates select="app:MD_DigTransferOpt/app:CI_OnlineResource"/>
					</onLine>
				</xsl:if>
				<xsl:if test="app:MD_DigTransferOpt/app:offlineMediumName or app:MD_DigTransferOpt/app:offlineMediumFormat">
					<offLine>
							...
							<xsl:if test="app:MD_DigTransferOpt/app:offlineMediumName">
								<name>
									<smXML:MD_MediumNameCode>
										...
										<xsl:attribute name="codeListValue"><xsl:value-of select="app:MD_DigTransferOpt/app:offlineMediumName/app:MD_MediumNameCode/app:codelistvalue"/></xsl:attribute>
									</smXML:MD_MediumNameCode>
								</name>
							</xsl:if>
							<xsl:if test="app:MD_DigTransferOpt/app:offlineMediumFormat">
								<mediumFormat>
									<smXML:MD_MediumFormatCode>
										...
										<xsl:attribute name="codeListValue"><xsl:value-of select="app:MD_DigTransferOpt/app:offlineMediumFormat/app:MD_MediumFormatCode/app:codelistvalue"/></xsl:attribute>
									</smXML:MD_MediumFormatCode>
								</mediumFormat>
							</xsl:if>
						</iso19115summary:MD_Medium>
	...
	<xsl:template name="dataident">
		<smXML:MD_DataIdentification>
			...
			<xsl:for-each select="app:identificationInfo/app:MD_Identification/app:status">
				<smXML:status>
					<smXML:MD_ProgressCode>
						...
						<xsl:attribute name="codeListValue"><xsl:value-of select="app:MD_ProgressCode/app:codelistvalue"/></xsl:attribute>
					</smXML:MD_ProgressCode>
				</smXML:status>
			</xsl:for-each>
			<xsl:for-each select="app:identificationInfo/app:MD_Identification/app:pointOfContact">
					...
					<smXML:MD_Keywords>
						...
						<smXML:type>
							<smXML:MD_KeywordTypeCode>
								...
								<xsl:attribute name="codeListValue"><xsl:value-of select="app:type/app:MD_KeywordTypeCode/app:codelistvalue"/></xsl:attribute>
							</smXML:MD_KeywordTypeCode>
						</smXML:type>
			...
			<xsl:apply-templates select="app:identificationInfo/app:MD_Identification/app:resourceMaintenance"/>
		...
		<smXML:CI_ResponsibleParty>
			...
			<smXML:role>
				<smXML:CI_RoleCode>
					...
					<xsl:attribute name="codeListValue"><xsl:value-of select="app:role/app:CI_RoleCode/app:codelistvalue"/></xsl:attribute>
				</smXML:CI_RoleCode>
			</smXML:role>
		</smXML:CI_ResponsibleParty>
	</xsl:template>
			...
			<xsl:if test="app:function">
				<smXML:function>
					<smXML:CI_OnLineFunctionCode>
						...
						<xsl:attribute name="codeListValue"><xsl:value-of select="app:function/app:CI_OnLineFunctionCode/app:codelistvalue"/></xsl:attribute>
					</smXML:CI_OnLineFunctionCode>
				</smXML:function>
			</xsl:if>
		</smXML:CI_OnlineResource>
			...
			<xsl:for-each select="app:presentationForm">
				<smXML:presentationForm>
					<smXML:CI_PresentationFormCode codeList="CI_PresentationFormCode">
						<xsl:attribute name="codeListValue"><xsl:value-of select="app:CI_PresentationFormCode/app:codelistvalue"/></xsl:attribute>
				...
				<smXML:accessConstraints>
					<xsl:for-each select="app:MD_RestrictionCode">
						<smXML:MD_RestrictionCode>
							...
							<xsl:attribute name="codeListValue"><xsl:value-of select="app:codelistvalue"/></xsl:attribute>
						</smXML:MD_RestrictionCode>
					</xsl:for-each>
				</smXML:accessConstraints>
			</xsl:for-each>
	...
	<xsl:template match="app:resourceMaintenance">
			...
			<smXML:MD_MaintenanceInformation>
				<smXML:maintenanceAndUpdateFrequency>
					<smXML:MD_MaintenanceFrequencyCode>
						...
						<xsl:attribute name="codeListValue"><xsl:value-of select="app:MD_MainFreqCode/app:codelistvalue"/></xsl:attribute>
					</smXML:MD_MaintenanceFrequencyCode>
				</smXML:maintenanceAndUpdateFrequency>
				<xsl:if test="../../../app:resourceMaintenance/app:MD_MaintenanceInformation[position()] != ''">
					<xsl:variable name="tst"><xsl:value-of select="position()"/></xsl:variable>
					<xsl:for-each select="../../../app:resourceMaintenance/app:MD_MaintenanceInformation">
						<xsl:if test="position() = $tst" >
	...
	<xsl:template name="test_template">
		<xsl:if test="boolean( app:dateOfNextUpdate )">
			<smXML:dateOfNextUpdate>
				<smXML:DateTime>
					<xsl:call-template name="toISODateTime">
						<xsl:with-param name="datetime">
							<xsl:value-of select="app:dateOfNextUpdate"/>
						</xsl:with-param>
					</xsl:call-template>
				</smXML:DateTime>
			</smXML:dateOfNextUpdate>
		</xsl:if>
		<xsl:if test="boolean(app:userDefinedMaintenanceFrequency )">
			<smXML:userDefinedMaintenanceFrequency>
				<smXML:TM_PeriodDuration>
					<xsl:value-of select="app:userDefinedMaintenanceFrequency"/>
				</smXML:TM_PeriodDuration>
			</smXML:userDefinedMaintenanceFrequency>
		</xsl:if>
		<xsl:if test="boolean( app:updateScope)">
			<smXML:updateScope>
				<smXML:MD_ScopeCode codeList="MD_ScopeCode">
					<xsl:attribute name="codeListValue"><xsl:value-of select="app:updateScope/app:MD_ScopeCode/app:codelistvalue"/></xsl:attribute>
				</smXML:MD_ScopeCode>
			</smXML:updateScope>
		</xsl:if>
		<xsl:if test="app:note">
	...
	<xsl:template match="app:DQ_Element">
        <xsl:if test="app:type = 'DQ_AbsoluteExternalPositionalAccuracy' or app:type = 'DQ_CompletenessCommission' ">
    		<smXML:report>
			...
			<xsl:if test="app:topoLevelCode">
				<smXML:topologyLevel>
					<smXML:MD_TopologyLevelCode>
						...
						<xsl:attribute name="codeListValue"><xsl:value-of select="app:topoLevelCode/app:MD_TopoLevelCode/app:codelistvalue"/></xsl:attribute>
					</smXML:MD_TopologyLevelCode>
				</smXML:topologyLevel>
			</xsl:if>
					...
					<smXML:MD_GeometricObjects>
						<smXML:geometricObjectType>
							<smXML:MD_GeometricObjectTypeCode>
								...
								<xsl:attribute name="codeListValue"><xsl:value-of select="app:geoTypeObjectTypeCode/app:MD_GeoObjTypeCode/app:codelistvalue"/></xsl:attribute>
							</smXML:MD_GeometricObjectTypeCode>
						</smXML:geometricObjectType>
	...
	<xsl:template name="distributioninfo">
		<iso19115:distributionInfo>
			<smXML:MD_Distribution>
				...
				<xsl:for-each select="app:distributor">
						...
						<smXML:MD_Medium>
							<xsl:if test="app:offlineMediumName">
								<smXML:name>
									<smXML:MD_MediumNameCode>
										<xsl:attribute name="codeList">MD_MediumNameCode</xsl:attribute>
										<xsl:attribute name="codeListValue"><xsl:value-of select="app:offlineMediumName/app:MD_MediumNameCode/app:codelistvalue"/></xsl:attribute>
									</smXML:MD_MediumNameCode>
								</smXML:name>
							</xsl:if>
							<xsl:if test="app:offlineMediumFormat">
								<smXML:mediumFormat>
									<smXML:MD_MediumFormatCode>
										<xsl:attribute name="codeList">MD_MediumFormatCode</xsl:attribute>
										<xsl:attribute name="codeListValue"><xsl:value-of select="app:offlineMediumFormat/app:MD_MediumFormatCode/app:codelistvalue"/></xsl:attribute>
									</smXML:MD_MediumFormatCode>
								</smXML:mediumFormat>
							</xsl:if>
						</smXML:MD_Medium>
